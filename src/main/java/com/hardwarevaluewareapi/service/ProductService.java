...
public class ProductService {
	...
	public List<Product> searchProductByName(String shopkeeperId, String name)
			throws InterruptedException, ExecutionException {

		ArrayList<Product> pl = new ArrayList<Product>();
		ApiFuture<QuerySnapshot> apiFuture = fireStore.collection("Product").whereEqualTo("shopKeeperId", shopkeeperId)
				.get();
		QuerySnapshot querySnapshot = apiFuture.get();
		List<QueryDocumentSnapshot> documentSnapshotList = querySnapshot.getDocuments();
		for (QueryDocumentSnapshot document : documentSnapshotList) {
	...
	public List<Product> getProductByCategoryAndShopkeeper(String categoryId, String shopKeeperId)
			throws InterruptedException, ExecutionException {
	...
	public List<CategoryWithProductList> getProductListByCategory(List<Category> list)
			throws InterruptedException, ExecutionException {
